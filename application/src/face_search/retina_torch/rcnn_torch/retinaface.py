...
from .backbone_models.net import MobileNetV1 as MobileNetV1  # noqa
from .backbone_models.net import FPN as FPN  # noqa
from .backbone_models.net import SSH as SSH  # noqa
...
class RetinaFace(nn.Module):
    def __init__(self, cfg=None, phase="train"):
        ...
        self.ClassHead = self._make_class_head(
            fpn_num=3, in_channels=cfg["out_channel"]
        )
